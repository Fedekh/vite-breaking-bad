...
export default {
    name: "SearchBar",
    emits: ["chiamataAlPadre"],       //dichiaro gli eventi figlio che saranno presenti
    data() {
        return {
...
<template>
    <div class="container mb-3 d-flex justify-content-center align-items-center gap-4">
        <div class="container-input d-flex flex-column">
